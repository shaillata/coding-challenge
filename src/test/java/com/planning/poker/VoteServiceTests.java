...
import com.planning.poker.serviceImpl.VoteServiceImpl;
...
class VoteServiceTests {
	...
	@Test
	void moveUserStoryStatusToVotedTest() {

		String uStoryId = "us1";
		
		Mockito.when(userStoryRepository.getById(uStoryId)).thenReturn(userStory2);
		Mockito.when(userStoryRepository.save(userStory2)).thenReturn(userStory2);
		UserStory us = voteServiceMocked.moveUserStoryStatusToVoted(uStoryId);
